...
/**
 * @brief Czech flag points shader
 *
 * @param outVertex out points
 * @param inVertex in points
...
Method::Method(MethodConstructionData const*){
  ...
  pushDrawCommand (commandBuffer,6*6*100,0);
}
...
EntryPoint main = [](){registerMethod<Method>("izg09 stairs");};
